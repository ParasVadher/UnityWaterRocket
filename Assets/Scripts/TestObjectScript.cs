...
public class TestObjectScript : MonoBehaviour
{
    ...
    bool check3;
    float startTime;
    public static List<float> ThrustList; //made static so it can be accessed in the 'Graph' scene 
    public static List<float> TimeList; //made static so it can be accessed in the 'Graph' scene 
    ...
    public void Test()
    {
        //executes when user presses test button
    ...
    public void Reset()
    {
        //resets test ame on user request
        Start();
    }
